...
const Credit = () => {
  ...
  const columns = [
    ...
    {
      title: (
        <h1 className="text-[#323197] text-lg font-bold">Type</h1>
      ),
      dataIndex: "number",
    },
    {
       ...
       <div>
            <Card className="rounded-2xl shadow-md">
              ...
              <div className="my-5">
                ...
                <Input.TextArea className="w-1/4 py-3 border border-gray-300 text-black  text-xl" placeholder="Affiliate Shopping" />
              </div>
