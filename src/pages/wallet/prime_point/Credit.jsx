...
const Credit = () => {
  ...
  const columns = [
    ...
    {
      title: (
        <h1 className="text-[#323197] text-lg font-bold">Transaction Type</h1>
      ),
      dataIndex: "number",
    },
    {
      title: <h1 className="text-[#323197] text-lg font-bold">Old Point</h1>,
      dataIndex: "operator",
    },
    {
      title: <h1 className="text-[#323197] text-lg font-bold">Point</h1>,
      dataIndex: "api",
    },
    {
      title: <h1 className="text-[#323197] text-lg font-bold">New Points</h1>,
    ...
    {
      title: <h1 className="text-[#323197] text-lg font-bold">Description</h1>,
      dataIndex: "status",
    },
  ];
    ...
    <>
      <div>
        <div className=" flex flex-wrap items-center">
          ...
          <Space className="lg:mx-2 " direction="">
            <Link to="/prime-point/credit/debit">
              <Card
                // activeTabKey="home"
                className={` ${
                  pathname == "/prime-point/credit/debit"
                    ? "bg-[#221ecf] text-white "
        ...
        {pathname == "/prime-point/credit" ? (
          <>
            ...
            <div>
              <Card className="rounded-2xl shadow-md">
                <div className="my5">
                  ...
                  <Input
                    className="w-1/4 py-3 border border-gray-300 text-black  text-xl"
            ...
            <div className="my-5">
              <h1 className="text-[#221ECF] text-3xl font-semibold my-5">
                Recent Transactions
              </h1>
              <Card className="rounded-2xl border border-gray-300 mb-14 shadow-md ">
                <div className="flex justify-between">
                  <div className="flex items-center bg-gray-50 border py-[4px] px-2 rounded-full">
